...
namespace WindowsFormsApp9
{
    public partial class FractalForm : Form
    {
        ...
        {
            this.MinimumSize = new Size(SystemInformation.VirtualScreen.Width / 2, SystemInformation.VirtualScreen.Height / 2);
        }
        ...
        private void сохранитькакToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Невозможно сохранить изображение, так как его нет");
            }
        }
